...
public class OfflineMarketShopCreateModel extends AlipayObject {
	...
	private static final long serialVersionUID = 2884414256745831218L;
	...
	/**
	 * 如业务参数中传递了version=2.0，则此字段默认不传和传入ISV的情况下，表示为ISV在调用接口；PROVIDER（支付宝内部使用字段）。2.0接口将不再支持传入MERCHANT字段。
	 */
	@ApiField("op_role")
